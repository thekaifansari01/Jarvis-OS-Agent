...
import random
import re
from PyQt5.QtCore import Qt, QTimer, QPropertyAnimation, QEasingCurve, QFileSystemWatcher, QPoint, QRect, QParallelAnimationGroup
...
class STTPopup(QWidget):
    def __init__(self):
        ...
        self.watcher.fileChanged.connect(lambda: self.update_timer.start(10))
