...
class OpenRouterProvider(BaseLLMProvider):
    def __init__(
        ...
        self.thinking_enabled = thinking_enabled if thinking_enabled is not None else OPENROUTER_THINKING_ENABLED
    ...
    def _convert_tools_to_openai(self, tools_list: List[Any]) -> List[Dict[str, Any]]:
        ...
        try:
            ...
            logger.error(f"❌ Error converting tools for OpenRouter: {e}")
            return []
        ...
        **kwargs
        ...
        try:
            ...
            headers = {
                ...
                "HTTP-Referer": "https://mindly.ai",
                "X-Title": "Jarvis Agentic Brain"
            }
    ...
    def generate_stream(
        ...
        **kwargs
        ...
        try:
            ...
            logger.error(f"❌ OpenRouterProvider stream error: {e}")
            yield {
                "content": "",
                "reasoning_content": "",
                "tool_calls": [],
